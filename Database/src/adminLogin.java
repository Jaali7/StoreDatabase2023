...
*/
		...
		JLabel lblNewLabel = new JLabel("Create New Admin");
		lblNewLabel.setBounds(144, 11, 117, 29);
		...
		lblNewLabel_3.setBounds(27, 231, 119, 19);
		...
		lblNewLabel_5.setBounds(332, 172, 46, 14);
	...
	public void addAdmin() {
		try {
			...
			String query = "INSERT INTO admins(adminUsername, adminPassword, adminFirstName, adminLastName, adminEmail) VALUES ( ?, ?, ?, ?, ?)";
			...
			JOptionPane.showMessageDialog(frame, "Error creating Admin: " + e.getMessage());
		}
	}
	...
	public void toLogin() {
		frame.dispose();
		adminreturnlogin CBD = new adminreturnlogin();
		CBD.initialize();
