...
public class employeeLogin {
	...
	public void initialize() {
		...
		*/
		...
		JLabel lblNewLabel = new JLabel("Create New Employee");
	...
	public void addCustomer() {
		try {
			...
			String query = "INSERT INTO employees(Employeeusername, Employeepassword, EmployeeFirstName, EmployeeLastName, empEmail) VALUES ( ?, ?, ?, ?, ?)";
	...
	public void toLogin() {
		frame.dispose();
		employeereturnlogin CBD = new employeereturnlogin();
		CBD.initialize();
